// 由于豆瓣读书不再提供公共api，使用此文件解密官网上搜素结果内容
var i = 16
var Q = 4096
var p = {
  start: 2,
...
function encry2arr_from(t, e, r) {  // 1  39  50  66
...
function o_19(t, e) {  // 19  21  59  61
  return true ? (t = new Uint8Array(e),
    t.__proto__ = Uint8Array.prototype) : (null === t && (t = new p_f(e)),
      t.length = e),
    t
}
...
function Bt(t) {
  ...
  function p(r) {
    ...
    if (s < e.maxObjectSize)
      return o({}, l, p_f(t.slice(n + 1, n + 1 + s)));
