...
<div class="moe-card">
  ...
  <div class="moe-body">
    {{pComment.author.name}}，您曾在文章<a href="{{postLink}}">《{{title}}》</a>上发表过评论：
...
const sendMail = (mailOptions: MailOption, data: commentTplData) => {
