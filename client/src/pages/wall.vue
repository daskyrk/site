<template>
  <div class="back">
    ...
    <div class="panel">
      ...
      <input ref="name" name="name" type="text" placeholder="路过的朋友">
...
.ding {
  ...
  background: -webkit-radial-gradient(
    ...
    -webkit-radial-gradient(50% 50%, circle closest-side, rgba(0, 0, 0, 0.4) 0, rgba(
            0,
            0,
            0,
            0.2
    ...
    -webkit-radial-gradient(50% 50%, ellipse closest-side, rgba(64, 150, 238, 1)
          0, rgba(64, 150, 238, 1) 100%),
  ...
  background: -moz-radial-gradient(
    ...
    -moz-radial-gradient(50% 50%, circle closest-side, rgba(0, 0, 0, 0.4) 0, rgba(
            0,
            0,
            0,
            0.2
          ...
          81%, rgba(255, 255, 255, 0) 92%, rgba(255, 255, 255, 0) 100%),
    -moz-radial-gradient(50% 50%, ellipse closest-side, rgba(64, 150, 238, 1) 0, rgba(
            64,
            150,
            238,
            1
