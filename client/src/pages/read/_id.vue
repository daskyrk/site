<template>
  <div class="read-thought">
    <div class="side">
      <div class="title">
        <nuxt-link to='../' append><i class="back iconfont icon-fanhui"></i></nuxt-link>
        {{bookInfo.title}}
      </div>
      <div class="author">
      ...
      <div class="img-wrap">
        <img :src="bookInfo.image | dealImg({h: 300})" alt="book-image">
      </div>
      <div v-if="bookInfo.saying" class="saying">
