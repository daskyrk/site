<template>
  <div id="listen" style="display: block;">
    <div class="player">
      <div class="box">
        <img src="https://p3.music.126.net/Jkr2d7T0r51pVA9utSRiig==/109951163096071991.jpg?param=300y300" width="80" height="80" class="cover pull-left">
        <div class="info pull-left">
          <h4 class="title nowrap" title="Wild - Monogem">Wild - Monogem</h4>
      ...
      <div class="list">
        <form method="get" class="music-search" action="" role="search">
          <span class="icon search-icon"></span> <input type="text" name="song" id="song-msg" class="textinput" placeholder="回车搜索..." required="required"> <input type="hidden" name="page" id="list-page" value="1">
          <div class="search-source">
            <span id="onsource" class="icon"></span>
          </div>
          <div class="source-items">
            <label><input type="radio" name="source" class="source checkbox-radio" value="netease" checked="checked">
              <span class="radioinput"></span>网易</label>
            <label><input type="radio" name="source" class="source checkbox-radio" value="tencent">
              <span class="radioinput"></span>QQ</label>
            <label><input type="radio" name="source" class="source checkbox-radio" value="xiami">
              <span class="radioinput"></span>虾米</label>
            <label><input type="radio" name="source" class="source checkbox-radio" value="kugou">
              <span class="radioinput"></span>酷狗</label>
            <label><input type="radio" name="source" class="source checkbox-radio" value="baidu">
              <span class="radioinput"></span>百度</label>
          </div>
        </form>
      ...
      <audio id="audio" class="bgm" type="audio/ogg" src="https://m10.music.126.net/20180806223625/9ce043c3fd42b2ed0f70ecd21cb152d2/ymusic/2b2e/a4ce/fb9f/0a8326bac44c452fd8dc3731cf4680f1.mp3"></audio>
    </div>
    <div id="temp"></div>
  </div>
</template>
...
<script>
import pl from '~/plugins/player.js';
